				...
				>
					<div class="flex flex-col gap-2">
						...
						<div class="flex items-center gap-2 overflow-hidden">
							<div
								class="flex items-center rounded-xl border border-gray-200 bg-white/80 p-0.5 text-[11px] dark:border-gray-800 dark:bg-gray-900/80"
							>
								<button
									class="rounded-[10px] px-2.5 py-1 transition {workspaceRoutingMode === 'auto'
										? 'bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900'
										: 'text-gray-600 dark:text-gray-300'}"
									on:click={() => setWorkspaceRoutingMode('auto')}
								>
									Auto
								</button>
								<button
									class="rounded-[10px] px-2.5 py-1 transition {workspaceRoutingMode === 'manual'
										? 'bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900'
										: 'text-gray-600 dark:text-gray-300'}"
									on:click={() => setWorkspaceRoutingMode('manual')}
								>
									Manual
								</button>
							</div>
