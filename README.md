...
This repository is being adapted into a unified AI workspace on top of Open WebUI.
Current fork-specific notes live in [docs/ai-workspace.md](docs/ai-workspace.md).
